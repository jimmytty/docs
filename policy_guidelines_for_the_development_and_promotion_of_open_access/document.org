* Policy Guidelines FOR THE DEVELOPMENT AND PROMOTION OF OPEN ACCESS [50%]
by Alma Swan
...
** DONE Section 1. The Development of Open Access to Scientific Information and Research [100%]
...
reward are hardly high[fn:23], but the fact that the potential for
...
Bermuda meeting in 1996[fn:24]. There is excellent provision of

public data storage and preservation facilities for scientists


in biomedical research[fn:25], as there is in some other data-
...
***** Summary points on the development of Open Access
...
** DONE Section 5. Business models [100%]
...
**** Summary points on business models for Open Access
